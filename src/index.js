...
const createBep20Token = async ({ name, symbol, supply, web3 }) => {
	const { chainId } = await web3.getNetwork();
	if (chainId !== 56) {
		throw "Incorrect Chain, please switch to Binance Smart Chain Mainnet";
	}
...
export { EmbeddedTokenGenerator, createBep20Token };